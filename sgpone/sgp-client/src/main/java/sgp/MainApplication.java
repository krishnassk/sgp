...
import sgp.screens.EditWorkScreen;
...
public class MainApplication extends Application
{
	...
	public static void main(String[] pArgs)
	{
		...
		System.setProperty(IPackageSetup.CONFIG_BASEDIR, new File(new File("../sgp-war/").getAbsolutePath(), "/src/main/webapp/WEB-INF").getAbsolutePath());
	...
	protected IConnection createConnection() throws Exception
	{
		...
		if (sConClass != null && HttpConnection.class.getName().equals(sConClass))
		{
			...
			if (sServerBase == null)
			{
				sServerBase = "http://localhost/sgp";
			}
